      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            {{-- <li><a href="calendar.html"><i class="ti-more"></i>Tambah Barang</a></li> --}}
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('antrian.view')}}"><i class="ti-more"></i>Tampilkan ANTRIAN</a></li>
            {{-- <li><a href="calendar.html"><i class="ti-more"></i>Tambah Barang</a></li> --}}
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('jadwal.view')}}"><i class="ti-more"></i>Tampilkan Jadwal</a></li>
            {{-- <li><a href="calendar.html"><i class="ti-more"></i>Tambah Barang</a></li> --}}
          </ul>
        </li> 
