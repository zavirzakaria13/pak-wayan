       ...
       <!-- Basic Forms -->
        <div class="box">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col">
                  <form method="post" action="{{route('barangs.update', $editData->id)}}">
                    @csrf
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="jenis" value="{{$editData->jenis}}" class="form-control" required data-validation-required-message="This field is required"> </div>
                            </div>
                        </div>
